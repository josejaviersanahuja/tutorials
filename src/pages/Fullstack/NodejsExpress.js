   ...
   const detalles={
        primero:{
            ...
            arrayCodigo:[
                ...
                {
                    cod:`node index.js 
//Una vez creado el proyecto, podemos abrir en VSC o el que sea. 
//crear nuestro index.js y ejecutarlo por consola `,
...
response.end('JSON.stringifynotes')} `,
