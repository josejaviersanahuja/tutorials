...
export default function VariablesFunciones() {
    ...
    const detalles={
        ...
        tercero:{
            ...
            arrayCodigo:[
                {
                    cod:"#{&}__paragraph2{@extend .main__paragraph; width: fit-content; };",
        ...
        cuarto:{
            ...
            arrayCodigo:[
                {
                    cod:"@for $i from 1to5 {.tem:nth-child(#{$i}){transition-delay:$i*0.1s}}",
